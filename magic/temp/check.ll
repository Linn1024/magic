...
entry:
  ...
  %arrayidx = getelementptr inbounds %struct._iobuf, %struct._iobuf* %call, i64 0
  %call1 = call %struct._iobuf* @freopen(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0), %struct._iobuf* %arrayidx)
  ...
  %arrayidx6 = getelementptr inbounds %struct._iobuf, %struct._iobuf* %call6, i64 0
  %call16 = call %struct._iobuf* @freopen(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0), %struct._iobuf* %arrayidx6)
  %call26 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %a)
